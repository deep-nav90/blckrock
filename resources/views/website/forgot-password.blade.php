...
<head>
   <meta charset="utf-8" />
   <title>Forgot Password-Black Rooster</title>
                  ...
                  <div class="left-side">
                     ...
                     <form id="forgotPasswordForm" method="POST">
                        ...
                        <div class="login-btn-sec justifySpace">
                           <a class="sub-btn back-btn" href="{{route('loginWeb')}}"><span>Back</span></a>
         ...
         forgotPasswordForm.validate({
           ...
           submitHandler:function(form){
                  ...
                  $("#lodaerModal").modal("show");
                   ...
                   var fd = new FormData();
                   var other_data = $('#forgotPasswordForm').serializeArray();
