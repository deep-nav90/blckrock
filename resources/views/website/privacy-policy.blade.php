...
<section>
  ...
  <ul>
    ...
    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Blackrooster Pvt Ltd.</li>
    <li><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</li>
    <li><strong>Country</strong> refers to: Punjab, India
...
<li><strong>Website</strong> refers to Blackrooster, accessible from blackrooster.com</li>
...
<h1>Use of Your Personal Data</h1>
    ...
    <h2>The Company may use Personal Data for the following purposes:</h2>
    <ul>
...
You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
  ...
  <ul>
    <li>By visiting this page on our website: <a href="blackrooster.com/contact">blackrooster.com/contact</a></li>
  </ul>
        </div>
    </div>
</section>
