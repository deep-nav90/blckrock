          ...
          <div class="card-body">
            ...
            <form id="addCategory" enctype='multipart/form-data'>
              ...
              <div class="mb-4 profile_image">
                <img src="{{$sub_category->sub_category_image}}" id="click_on_image" alt="" style="cursor:pointer;">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="sub_category_name" class="form-control" value="{{$sub_category->sub_category_name}}" id="sub_category_name" maxlength="30">
