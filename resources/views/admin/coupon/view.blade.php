                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="coupon_name" value="{{$coupon->coupon_name}}" disabled class="form-control" id="coupon_name" maxlength="30">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="coupon_type" id="coupon_type"  class="form-control w-100 ml-0" disabled>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="coupon_amount_and_percentage" value="{{$coupon->coupon_amount_and_percentage}}" class="form-control coupon_amount_and_percentage numeric_check" id="coupon_amount_and_percentage" disabled>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="date" name="from_date" value="{{$coupon->from_date}}" class="form-control" id="from_date" disabled>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="date" name="to_date" value="{{$coupon->to_date}}" class="form-control" id="to_date" disabled>
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="coupon_code" class="form-control" value="{{$coupon->coupon_code}}" id="coupon_code" disabled/>
