                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="coupon_name" value="{{$coupon->coupon_name}}" class="form-control" id="coupon_name" maxlength="30">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="coupon_type" id="coupon_type" class="form-control w-100 ml-0">
                            ...
                            <option value="Flat" @if($coupon->coupon_type == 'Flat') selected @endif()>Flat</option>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="coupon_amount_and_percentage" value="{{$coupon->coupon_amount_and_percentage}}" class="form-control coupon_amount_and_percentage numeric_check" id="coupon_amount_and_percentage">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="meta_keyword" class="form-control" value="{{$coupon->meta_keyword}}" id="meta_keyword" maxlength="50">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="date" name="from_date" value="{{$coupon->from_date}}" class="form-control" id="from_date">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="date" name="to_date" value="{{$coupon->to_date}}" class="form-control" id="to_date">
                  ...
                  <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <textarea type="text" name="meta_description" class="form-control textareaClass" id="meta_description">{{$coupon->meta_description}}</textarea>
    ...
    $(document).ready(function() {
      ...
      addCoupon.validate({
        ...
        submitHandler:function(form){
                ...
                $.ajax({
                    url:"{{route('edit_coupon',$coupon_id)}}",
                    data: fd,
                    contentType: false,
                    processData: false,
                    type: 'POST',
