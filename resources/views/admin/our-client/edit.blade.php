                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="our_client_name" class="form-control" value="{{$our_client->our_client_name}}" id="our_client_name" maxlength="30">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="title" value="{{$our_client->title}}" maxlength="50">
                ...
                <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <textarea type="text" name="description" class="form-control textareaClass" id="description">{{$our_client->description}}</textarea>
    ...
    $(document).ready(function() {
      ...
      addOurClient.validate({
        ...
        submitHandler:function(form){
                ...
                $.ajax({
                    url:"{{route('edit_our_client',$our_client_id)}}",
                    data: fd,
                    contentType: false,
                    processData: false,
                    type: 'POST',
