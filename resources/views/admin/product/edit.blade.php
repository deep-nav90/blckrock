            ...
            <form id="addProduct" method="POST" enctype='multipart/form-data'>
              ...
              <div class="upload_align">
                ...
                <div class="user_img mr-2" title="Click to upload images" style="
                  ...
                  <img class="click_upload img_upload file_upload_click" src="{{url('/public/dum5_l.jpg')}}" style="cursor: pointer;" alt="woman">
                ...
                <div class="user_img mr-2" ui="image" title="Upload Image/Video/Audio" style="position: relative; margin-bottom: 16px;">
                  ...
                  <div class="add_img cross_icon">
                    <img class="click_upload plus_icon cross_icon_old" del_id = "{{$productImage->id}}" ui="image" src="{{url('/public/cross.png')}}" alt="cross">
                  </div>
                  ...
                  <div class="custom_check_wrap">
                    <div class="custom-check">
                      <input type="checkbox" data_id="{{$productImage->id}}" name="old_checkbox" value="{{$productImage->id}}" @if($productImage->is_featured_image == 1) checked @endif() class="featured_checkbox_old chec" type_of_check="old">
                      <span></span>       
                    </div>
                ...
                <div class="information_fields">
                  <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="sub_category_id" id="sub_category_id" class="form-control w-100 ml-0">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="product_name" class="form-control" value="{{$product_find->product_name}}" id="product_name" maxlength="50">
                  ...
                  <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="product_quantity" value="{{$product_find->product_quantity}}" class="form-control numeric_check" id="product_quantity" maxlength="50">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="meta_keyword" class="form-control" id="meta_keyword" value="{{$product_find->meta_keyword}}" maxlength="50">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <textarea type="text" name="meta_description" class="form-control textareaClass" id="meta_description">{{$product_find->meta_description}}</textarea>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <textarea type="text" name="product_description" class="form-control textareaClass" id="product_description">{{$product_find->product_description}}</textarea>
                    ...
                    <div class="row mt-4 product_attribute" data-index="{{$i}}">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="product_price[{{$i}}]" value="{{$product_price_attribute->product_price}}" validate_name="Product Price" class="form-control numeric_check jqValidate">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                          <label for="name">Sale Price<span class="text-danger"> *</span></label>
                          <input type="text" name="sale_price[{{$i}}]" value="{{$product_price_attribute->sale_price}}" validate_name="Sale Price" class="form-control numeric_check jqValidate">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <select name="attribute_ids[{{$i}}]" validate_name="Attribute" class="form-control w-100 ml-0 jqValidate">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="attribute_value[{{$i}}]" validate_name="Attribute Value" class="form-control numeric_check jqValidate" value="{{$product_price_attribute->attribute_value}}"  maxlength="30">
                        </div>
                      </div>


                      <div class="custom-check defaultCheckboxSelect">
                        <input type="checkbox" index_id="{{$i}}" name="is_default[{{$i}}]" value="{{$i}}"  class="selectCheckBoxIndexID" @if($product_price_attribute->is_default_show == 1) checked @endif()>
                        <span></span>       
                      </div>

                      @if($i == 0)

                      <div class="plus_minus_icon" icon_type = "plus" index_id="{{$i}}">
                        <img class="icon_img" src="{{url('public/images/plus-icon.png')}}">
                      </div>

                      @else
                      <div class="plus_minus_icon" icon_type = "minus" index_id="{{$i}}">
