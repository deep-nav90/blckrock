              ...
              <div class="card-body">
                ...
                <div class="information_fields">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="category_id" id="category_id" class="form-control w-100 ml-0">
                            ...
                            <option class="optionCategory" full_data="{{$category}}" value="{{$category->id}}">{{$category->category_name}}</option>
                            @endforeach()
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="product_name" class="form-control" id="product_name" maxlength="50">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="product_quantity" class="form-control numeric_check" id="product_quantity" maxlength="50">
                  ...
                  <div class="attribute_and_product_price appendAttributeProductPrice">
                    ...
                    <div class="row mt-4 product_attribute" data-index="0">


                      <div class="col-sm-2">
                        <div class="form-group">
                          <label for="name">Product Price<span class="text-danger"> *</span></label>
                          <input type="text" name="product_price[0]" validate_name="Product Price" class="form-control numeric_check jqValidate">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" name="sale_price[0]" validate_name="Sale Price" class="form-control numeric_check jqValidate">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <select name="attribute_ids[0]" validate_name="Attribute" class="form-control w-100 ml-0 jqValidate">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <input type="text" name="attribute_value[0]" validate_name="Attribute Value" class="form-control numeric_check jqValidate"  maxlength="30">
                        </div>
                      </div>


                      <div class="custom-check defaultCheckboxSelect">
                        <input type="checkbox" index_id="0" name="is_default[0]" value="0"  class="selectCheckBoxIndexID" checked>
                        <span></span>       
                      </div>

                      <div class="plus_minus_icon" icon_type = "plus" index_id="0">
    ...
    $(document).ready(function() {
      ...
      addProduct.validate({
        ...
        messages: {
          ...
          sub_category_id: {
            required: "Please seletc sub category."
          },
          product_name: {
          ...
          // 'attribute_ids[]' : {
          //   required : "Select Attribute is required."
          // },
