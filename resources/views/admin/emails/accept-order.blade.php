                    ...
                    border-radius: 10px;box-shadow: 0 0 25px #1111111a;margin:auto;width:100%;min-width: 320px;" class="inner-table">
                            <tr>
                                <td style="text-align: center;">
                                    ...
                                    <p style="color: #454860;margin: 0;font-size: 14px;text-align: center;line-height:30px  ">Your order ({{$find_order->unique_order_id}}) has been accepted successfully.</p>
                                </td>
                            </tr>
